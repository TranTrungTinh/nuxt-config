...
export default {
  ...
  methods: {
    ...
    closeLeft(e) {
      ...
      if (currentIndex > 0) {
        ...
        this.$message.info('No Tab on the left')
      }
    },
    closeRight(e) {
      const currentIndex = this.fullPathList.indexOf(e)
      if (currentIndex < (this.fullPathList.length - 1)) {
        ...
        this.$message.info('No Tab on the right')
      }
    },
    closeAll(e) {
      const currentIndex = this.fullPathList.indexOf(e)
    ...
    renderTabPaneMenu(e) {
      return (
        <a-menu {...{ on: { click: this.closeMenuClick } }}>
          ...
          <a-menu-item key="close-right" data-vkey={e}>Close Tabs to the right</a-menu-item>
          <a-menu-item key="close-left" data-vkey={e}>Close Tabs to the left</a-menu-item>
  ...
  render() {
    ...
    const panes = pages.map((page) => {
      // TODO cheat.
      const title = page.fullPath.split('/').pop()
      return (
        <a-tab-pane
          style={{ height: 0 }}
          tab={this.renderTabPane(page.meta.title || title, page.fullPath)}
